...
/* External objects */
extern mplusplus_intg syntaxErrorNumber /* number of syntax errors reported by the parser */;
extern mplusplus_intg line; /* source code line number - defined in scanner.c */
...
extern mplusplus_void startParser(mplusplus_void);
extern mplusplus_intg startScanner(BufferPointer sc_buf);

static mplusplus_void displayParser(BufferPointer ptrBuffer);
static mplusplus_long getParserFileSize(mplusplus_char* fname);
static mplusplus_void callGarbageCollector(mplusplus_void);
...
mplusplus_long getParserFileSize(mplusplus_char* fname) {
	FILE* input;
	mplusplus_long flength;
	input = fopen(fname, "r");
	if (input == NULL) {
...
mplusplus_void displayParser(BufferPointer ptrBuffer) {
...
mplusplus_void callGarbageCollector(mplusplus_void) {
