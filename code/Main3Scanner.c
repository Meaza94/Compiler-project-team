...
/*
 * -------------------------------------------------------------
 *  Global vars and External vars for mplusplus Math DSL
 * -------------------------------------------------------------
 */

 /* Global objects - variables (used in other codes as external) */
BufferPointer stringLiteralTable;      /* String Literal Table for mplusplus */
mplusplus_intg errorNumber;             /* Run-time error number = 0 by default (ANSI) */

/* External objects */
extern mplusplus_intg line;             /* Source code line numbers - defined in scanner.c */
extern Token tokenizer(mplusplus_void);

/*
 * -------------------------------------------------------------
 *  Function declarations for mplusplus Math DSL Scanner
 * -------------------------------------------------------------
 */
mplusplus_void printScannerError(mplusplus_strg fmt, ...);
mplusplus_void displayScanner(BufferPointer ptrBuffer);
mplusplus_long getScannerFilesize(mplusplus_strg fname);
mplusplus_void printToken(Token t);

/*
************************************************************
 *  mplusplus Math DSL Scanner Main function
 * Parameters:
...
mplusplus_intg main3Scanner(mplusplus_intg argc, mplusplus_strg* argv) {
    ...
    mplusplus_intg loadSize = 0;        /* The size of the file loaded in the buffer */
    ...
    printf("\nScanning mplusplus Math DSL source file...\n\n");
...
/*
************************************************************
 *  Error printing function with variable number of arguments for mplusplus Math DSL
...
/*
************************************************************
 * The function displays buffer contents for mplusplus Math DSL
 * Param:
...
/*
 ************************************************************
 * The function gets size of scanner file for mplusplus Math DSL
 * Param:
 *	- Filename
 * Return:
 *	- Size of the file
